...
const NetworkMonitoringCard = () => {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <p className="text-sm text-gray-600 mb-6">قياس سرعة ومستوى أداء الشبكة بشكل مباشر</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-blue-50 rounded-lg p-4">
            ...
            <div className="text-2xl font-bold text-gray-800">70 Mbps</div>
          </div>
          ...
          <div className="bg-green-50 rounded-lg p-4">
            ...
            <div className="text-2xl font-bold text-gray-800">35 Mbps</div>
          </div>
          ...
          <div className="bg-yellow-50 rounded-lg p-4">
            ...
            <div className="text-2xl font-bold text-gray-800">12 ms</div>
          </div>
        </div>
